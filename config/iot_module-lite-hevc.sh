...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-ffserver" # ff4.0编译报错: Unknown option "--disable-ffserver"
...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --disable-vda" # ff4.0编译报错: Unknown option "--disable-vda"
